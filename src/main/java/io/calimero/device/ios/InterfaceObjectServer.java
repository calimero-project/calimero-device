...
import io.calimero.mgmt.PropertyClient.ResourceHandler;
 ...
 * {@link io.calimero.mgmt.PropertyClient.ResourceHandler} interface is used. It supports
...
{
	private final Logger logger = LogService.getLogger(MethodHandles.lookup().lookupClass());
	...
	public InterfaceObject addInterfaceObject(final int objectType)
	{
		...
		if (io instanceof final SecurityObject securityObject)
